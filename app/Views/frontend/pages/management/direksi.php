<?php $breadcrumbs = [['label'=>'Beranda','url'=>'/'],['label'=>'Manajemen','url'=>'/manajemen'],['label'=>'Dewan Direksi']]; ?>
<div class="page-header">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 page-header-content">
        <h1 class="text-3xl md:text-4xl font-heading font-bold text-white mb-2">Dewan Direksi</h1>
